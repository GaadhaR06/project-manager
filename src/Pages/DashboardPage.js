  ...
  return (
    <div className="p-8 text-center w-screen">
      <div className="flex justify-between w-{100%}">
        <h2 className="my-8 mr-64 text-3xl"> Your projects</h2>
        <Link to='/addproject'>  <button className=' my-8 font-bold rounded-md bg-[#003C43] px-8 text-white'> ADD PROJECT
        </button></Link></div>
              ...
              return (
                <>
                  <Link to={`/project/${item.id}`}>
                    <div className=' rounded-md bg-[#77B0AA] m-6 p-5'>
